...
// 표/총점 반영 키(이미지 순서)
const GROUPS = [
  { keys: ["topic_clarity", "narrative", "originality"] },                    // 내용 (50 = 15*3 + 기본5)
...
const TOTAL_MAX_INCLUDED = ORDERED_KEYS.reduce((acc, k) => acc + (MAX_SCORES[k] || 0), 0); // 93
                      ...
                      <tr key={key} className=''>
                        ...
                        <td className='p-1'>
						  ...
						  {result.map((essayScore, idx) => {
							...
							const maxAdjRef = MAX_SCORES[key];               // 분모는 원만점(6 또는 15)
