...
const Nav = ({ currentPage }) => {
	...
	return (
		<nav className="bg-slate-50 fixed w-full bg-opacity-50 backdrop-blur z-50 shadow-sm">
			<div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex justify-between items-center h-12">
