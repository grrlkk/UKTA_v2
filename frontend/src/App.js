		...
		<div className="App text-slate-900 bg-white transition-all ease-in-out min-w-[320px]">
			...
			<div className="items-start pt-32 grid grid-cols-1 gap-32 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className='grid grid-cols-1 gap-4'>
					...
					<div className='grid grid-cols-1 gap-4 p-4 border border-gray-300 rounded-lg bg-slate-100 shadow'>
						<div className='flex justify-end gap-2 text-sm shrink'>
							<input type="file" id="fileInput" accept=".txt" onChange={handleFileInputChange}
								...
								file:cursor-pointer
								bg-slate-200 hover:bg-slate-300 rounded-full grow sm:grow-0 shrink transition-all ease-in-out w-1/3
								"
							/>
