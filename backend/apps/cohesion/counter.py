...
def counter(text, sentences, words, kkma, kkma_list, kkma_simple):
    ...
    result["CLD"] = len(morphLst_content) / len(kkma)
    result["FLD"] = len(morphLst_formal) / len(kkma)
    result["NLD"] = len(morphLst_noun) / len(kkma)
    result["NNGLD"] = len(morphLst_NNG) / len(kkma)
    result["NNPLD"] = len(morphLst_NNP) / len(kkma)
    result["NNBLD"] = len(morphLst_NNB) / len(kkma)
    result["NPLD"] = len(morphLst_NP) / len(kkma)
    result["NMLD"] = len(morphLst_NR) / len(kkma)
    result["VLD"] = len(morphLst_verb) / len(kkma)
    result["VVLD"] = len(morphLst_VV) / len(kkma)
    result["VALD"] = len(morphLst_VA) / len(kkma)
    result["MLD"] = len(morphLst_mod) / len(kkma)
    result["MMLD"] = len(morphLst_MM) / len(kkma)
    result["MALD"] = len(morphLst_MA) / len(kkma)
    result["JLD"] = len(morphLst_J) / len(kkma)
    result["ELD"] = len(morphLst_E) / len(kkma)
    result["XLD"] = len(morphLst_X) / len(kkma)
    result["ITLD"] = len(morphLst_IC) / len(kkma)

    result["NCLD"] = len(morphLst_noun) / len(morphLst_content)
    result["NNCLD"] = len(morphLst_NNG) / len(morphLst_content)
    result["NNGCLD"] = len(morphLst_NNP) / len(morphLst_content)
    result["NNBCLD"] = len(morphLst_NNB) / len(morphLst_content)
    result["NPCLD"] = len(morphLst_NP) / len(morphLst_content)
    result["NMCLD"] = len(morphLst_NR) / len(morphLst_content)
    result["VCLD"] = len(morphLst_verb) / len(morphLst_content)
    result["VVCLD"] = len(morphLst_VV) / len(morphLst_content)
    result["VACLD"] = len(morphLst_VA) / len(morphLst_content)
    result["MCLD"] = len(morphLst_mod) / len(morphLst_content)
    result["MMCLD"] = len(morphLst_MM) / len(morphLst_content)
    result["MACLD"] = len(morphLst_MA) / len(morphLst_content)
    result["INCLD"] = len(morphLst_IC) / len(morphLst_content)
    result["JFLD"] = len(morphLst_J) / len(morphLst_formal)
    result["EFLD"] = len(morphLst_E) / len(morphLst_formal)
    result["XFLD"] = len(morphLst_X) / len(morphLst_formal)
