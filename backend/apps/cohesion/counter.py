...
def counter(text, sentences, words, kkma, kkma_list, kkma_simple):
	...
	result["morphDen_CL"] = len(morphLst_content) / len(kkma)
	result["morphDen_FL"] = len(morphLst_formal) / len(kkma)
	result["morphDen_NL"] = len(morphLst_noun) / len(kkma)
	result["morphDen_NNGL"] = len(morphLst_NNG) / len(kkma)
	result["morphDen_NNPL"] = len(morphLst_NNP) / len(kkma)
	result["morphDen_NNBL"] = len(morphLst_NNB) / len(kkma)
	result["morphDen_NPL"] = len(morphLst_NP) / len(kkma)
	result["morphDen_NML"] = len(morphLst_NR) / len(kkma)
	result["morphDen_VL"] = len(morphLst_verb) / len(kkma)
	result["morphDen_VVL"] = len(morphLst_VV) / len(kkma)
	result["morphDen_VAL"] = len(morphLst_VA) / len(kkma)
	result["morphDen_ML"] = len(morphLst_mod) / len(kkma)
	result["morphDen_MML"] = len(morphLst_MM) / len(kkma)
	result["morphDen_MAL"] = len(morphLst_MA) / len(kkma)
	result["morphDen_JL"] = len(morphLst_J) / len(kkma)
	result["morphDen_EL"] = len(morphLst_E) / len(kkma)
	result["morphDen_XL"] = len(morphLst_X) / len(kkma)
	result["morphDen_ITL"] = len(morphLst_IC) / len(kkma)

	result["morphDen_NCL"] = len(morphLst_noun) / len(morphLst_content)
	result["morphDen_NNCL"] = len(morphLst_NNG) / len(morphLst_content)
	result["morphDen_NNGCL"] = len(morphLst_NNP) / len(morphLst_content)
	result["morphDen_NNBCL"] = len(morphLst_NNB) / len(morphLst_content)
	result["morphDen_NPCL"] = len(morphLst_NP) / len(morphLst_content)
	result["morphDen_NMCL"] = len(morphLst_NR) / len(morphLst_content)
	result["morphDen_VCL"] = len(morphLst_verb) / len(morphLst_content)
	result["morphDen_VVCL"] = len(morphLst_VV) / len(morphLst_content)
	result["morphDen_VACL"] = len(morphLst_VA) / len(morphLst_content)
	result["morphDen_MCL"] = len(morphLst_mod) / len(morphLst_content)
	result["morphDen_MMCL"] = len(morphLst_MM) / len(morphLst_content)
	result["morphDen_MACL"] = len(morphLst_MA) / len(morphLst_content)
	result["morphDen_INCL"] = len(morphLst_IC) / len(morphLst_content)
	result["morphDen_JFL"] = len(morphLst_J) / len(morphLst_formal)
	result["morphDen_EFL"] = len(morphLst_E) / len(morphLst_formal)
	result["morphDen_XFL"] = len(morphLst_X) / len(morphLst_formal)
