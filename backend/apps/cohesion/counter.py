	...
	for i in range(len(kkma_list)):
		for pos in kkma_list[i]:
			if pos[1] in morphs_content:
				morphLst_content.append((len(morphLst_content), pos[0], pos[1], sentences[i]))
				if pos[1] in morphs_substansive:  # 체언
					morphLst_substansive.append((len(morphLst_substansive), pos[0], pos[1], sentences[i]))
					if pos[1] in morphs_noun:
						morphLst_noun.append((len(morphLst_noun), pos[0], pos[1], sentences[i]))
						if pos[1] == "NNG":
							morphLst_NNG.append((len(morphLst_NNG), pos[0], pos[1], sentences[i]))
						elif pos[1] == "NNP":
							morphLst_NNP.append((len(morphLst_NNP), pos[0], pos[1], sentences[i]))
						elif pos[1] == "NNB" or pos[1] == "NNBC":
							morphLst_NNB.append((len(morphLst_NNB), pos[0], pos[1], sentences[i]))
					elif pos[1] == "NP":
						morphLst_NP.append((len(morphLst_NP), pos[0], pos[1], sentences[i]))
						if pos[0] in morphs_NP_people:
							morphLst_NP_people.append((len(morphLst_NP_people), pos[0], pos[1], sentences[i]))
						elif pos[0] in morphs_NP_things:
							morphLst_NP_things.append((len(morphLst_NP_things), pos[0], pos[1], sentences[i]))
					elif pos[1] == "NR":
						morphLst_NR.append((len(morphLst_NR), pos[0], pos[1], sentences[i]))
				elif pos[1] == "IC":
					morphLst_IC.append((len(morphLst_IC), pos[0], pos[1], sentences[i]))

				elif pos[1] in morphs_verb:
					morphLst_verb.append((len(morphLst_verb), pos[0], pos[1], sentences[i]))
					if pos[1] == "VV":
						morphLst_VV.append((len(morphLst_VV), pos[0], pos[1], sentences[i]))
					elif pos[1] == "VA":
						morphLst_VA.append((len(morphLst_VA), pos[0], pos[1], sentences[i]))
					elif pos[1] == "VX":
						morphLst_VX.append((len(morphLst_VX), pos[0], pos[1], sentences[i]))
					elif pos[1] == "VCP":
						morphLst_VCP.append((len(morphLst_VCP), pos[0], pos[1], sentences[i]))
					elif pos[1] == "VCN":
						morphLst_VCN.append((len(morphLst_VCN), pos[0], pos[1], sentences[i]))

				elif pos[1] in morphs_mod:
					morphLst_mod.append((len(morphLst_mod), pos[0], pos[1], sentences[i]))
					if pos[1] == "MM":
						morphLst_MM.append((len(morphLst_MM), pos[0], pos[1], sentences[i]))
					elif pos[1] in morphs_MA:
						morphs_MA.append((len(morphs_MA), pos[0], pos[1], sentences[i]))

			elif pos[1] in morphs_formal:
				morphLst_formal.append((len(morphLst_formal), pos[0], pos[1], sentences[i]))
